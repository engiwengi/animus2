...
//     clients: HashMap<NetworkId, mpsc::UnboundedSender<EncodedPacket>>,
// }
//
// impl NetworkServer {
...
//     }
//
//     pub fn send<T>(&self, packet: T, connection_id: NetworkId) -> Result<()>
//     where
//         ServerPacket: From<T>,
//     {
...
//         sender
//             .send(encoded_packet)
//             .map_err(|_| Error::Generic("Sender unexpectedly
// closed".to_owned()))?;
//
//         Ok(())
//     }
...
//         &self,
//         packet: T,
//         connection_ids: impl IntoIterator<Item = NetworkId>,
//     ) -> Result<()>
//     where
//         ServerPacket: From<T>,
//     {
//         let encoded_packet = EncodedPacket::try_encode::<T,
// ServerPacket>(packet)?;         let iter = connection_ids.into_iter();
...
//     }
//
//     pub fn broadcast_all<T>(&self, packet: T) -> Result<()>
//     where
//         ServerPacket: From<T>,
//     {
//         let encoded_packet = EncodedPacket::try_encode::<T,
// ServerPacket>(packet)?;         info!("Sending packet #{}", next_id());
//
...
//     }
//
//     pub fn clients(&self) -> impl Iterator<Item = NetworkId> + '_ {
...
//                 let encoded_packet =
//                     EncodedPacket::try_encode::<AcceptConnection,
// ServerPacket>(packet).unwrap();
